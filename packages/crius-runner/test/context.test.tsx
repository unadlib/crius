...
test('runner deep step with JSX', async () => {
  ...
  interface StepFunctionWithContext<P = {}, C = {}> extends StepFunction<P, C & { bar: string }> {}

  const FooBar: StepFunctionWithContext<{ fooBar: string }> = (props, context) => {
